...
enum SporkId : int32_t {
  //SPORK_1_MASTERNODE_PAYMENTS_ENFORCEMENT     not used   = 10000,
    SPORK_2_INSTANTSEND_ENABLED                            = 10001,
    SPORK_3_INSTANTSEND_BLOCK_FILTERING                    = 10002,
  //SPORK_4_FREE                                not used   = 10003,
  //SPORK_5_INSTANTSEND_MAX_VALUE               not used   = 10004,
    SPORK_6_FREE                             /* not used */= 10005,
  //SPORK_7_MASTERNODE_SCANNING                 not used   = 10006,
  //SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT      not used   = 10007,
    SPORK_9_SUPERBLOCKS_ENABLED                            = 10008,
  //SPORK_10_MASTERNODE_PAY_UPDATED_NODES       not used   = 10009,
  //SPORK_11_RESET_BUDGET                       not used   = 10010,
  //SPORK_12_RECONSIDER_BLOCKS                             = 10011,
  //SPORK_13_OLD_SUPERBLOCK_FLAG                not used   = 10012,
  //SPORK_14_REQUIRE_SENTINEL_FLAG              not used   = 10013,
  //SPORK_15_DETERMINISTIC_MNS_ENABLED                     = 10014,
  //SPORK_16_INSTANTSEND_AUTOLOCKS                         = 10015,
    SPORK_17_QUORUM_DKG_ENABLED                            = 10016,
  //SPORK_18_QUORUM_DEBUG_ENABLED                          = 10017,
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        // not reuse pubkeys from previous dmsd run
        LOCK(cs);
