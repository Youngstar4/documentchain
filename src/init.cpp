...
public:
    ...
    // DMS Specific WalletInitInterface InitPrivateSendSettings
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    if (mode == HMM_BITCOIN_QT)
        strUsage += HelpMessageOpt("-windowtitle=<name>", _("Sets a window title which is appended to \"DMS Core - \""));
    ...
    strUsage += HelpMessageOpt("-sporkaddr=<dmsaddress>", strprintf(_("Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.")));
