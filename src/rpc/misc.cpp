...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in docz\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in docz\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in docz\n"
            "  \"received\": xxxxx              (numeric) The total number of docz received (including change)\n"
            "}\n"
            "\nExamples:\n"
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Document index */
    { "documentindex",      "getdocumentcount",       &getdocumentcount,       {} },
