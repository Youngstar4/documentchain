...
//! Interface for the src/evo part of a dms node (dmsd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a dms node (dmsd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a dms node (dmsd process).
...
//! Top-level interface for a dms node (dmsd process).
class Node
{
public:
    virtual ~Node() {}
