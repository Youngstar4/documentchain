...
void RPCConsole::setButtonIcons()
{
    ...
    GUIUtil::setIcon(ui->fontBiggerButton, "fontbigger", GUIUtil::ThemedColor::DMSRED, consoleButtonsSize);
    GUIUtil::setIcon(ui->fontSmallerButton, "fontsmaller", GUIUtil::ThemedColor::DMSRED, consoleButtonsSize);
}

void RPCConsole::reloadThemedWidgets()
{
    clear();
    ui->promptLabel->setHidden(GUIUtil::dmsThemeActive());
