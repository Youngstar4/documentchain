...
/** Utility functions used by the DMS Qt UI.
 */
namespace GUIUtil
{
    ...
    enum class ThemedColor {
        ...
        UNCONFIRMED,
        /* Theme related DMS´s dark red color */
        DMSRED,
    ...
    QIcon getIcon(const QString& strIcon, ThemedColor color = ThemedColor::DMSRED, const QString& strIconPath = ICONS_PATH);
    ...
    void setIcon(QAbstractButton* button, const QString& strIcon, ThemedColor color = ThemedColor::DMSRED, const QSize& size = QSize(BUTTON_ICONSIZE, BUTTON_ICONSIZE));
    ...
    // Parse "dms:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load dms specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a dms specific theme is activated (light/dark).*/
    bool dmsThemeActive();
