...
//
//     src/qt/test/test_dms-qt -platform xcb      # Linux
//     src/qt/test/test_dms-qt -platform windows  # Windows
//     src/qt/test/test_dms-qt -platform cocoa    # macOS
void TestGUI()
{
    GUIUtil::loadFonts();
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: dms:")) != -1);
