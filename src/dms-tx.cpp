...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dms-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dms-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dms transaction") + "\n" +
              "  dms-tx [options] -create [commands]   " + _("Create hex-encoded dms transaction") + "\n" +
              "\n";
