...
def append_config(datadir, options):
    with open(os.path.join(datadir, "dms.conf"), 'a', encoding='utf8') as f:
...
def get_auth_cookie(datadir, chain):
    user = None
    password = None
    if os.path.isfile(os.path.join(datadir, "dms.conf")):
        with open(os.path.join(datadir, "dms.conf"), 'r', encoding='utf8') as f:
            for line in f:
