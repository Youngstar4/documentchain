...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # node0 should end up with 1000 DMS in block rewards plus fees, but
        ...
        # Send 100 DMS with subtract fee from amount
        ...
        # Sendmany 100 DMS with subtract fee from amount
