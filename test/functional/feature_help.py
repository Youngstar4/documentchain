...
"""Verify that starting dmsd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dmsd with -h for help text")
        ...
        self.log.info("Start dmsd with -version for version information")
