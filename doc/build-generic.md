GENERIC BUILD NOTES
====================
Some notes on how to build DMS Core based on the [depends](../depends/README.md) build system.

Note on old build instructions
------------------------------
In the past, the build documentation contained instructions on how to build DMS with system-wide installed dependencies
...
------------------------------------
Building the dependencies and DMS Core requires some essential build tools to be installed before. Please see
...
This will download and build all dependencies required to build DMS Core. Caching of build results will ensure that only
...
not done, build failures might occur when building DMS.
