...
This document provides guidelines for internationalization of the DMS Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dms_en.ts` remains unchanged.
