...
The ZeroMQ feature in DMS Core requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ dmsd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/dmsd.tx.raw
...
From the perspective of dmsd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into dmsd directly. Furthermore, no information is
