...
dmsd/dash-qt (on Linux). If you upgrade after DIP0003 activation you will
...
`privatesendsessions` cmd-line option or dms.conf. You can pick any number of sessions between 1 and 10,
...
See `Help -> Command-line options` in Qt wallet or `dmsd --help` for more info.
...
- [`1c9ed7806`](https://github.com/dashpay/dash/commit/1c9ed7806) GDB automation with Python script to measure memory usage in dmsd (#1609)
