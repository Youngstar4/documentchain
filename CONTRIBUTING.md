Contributing to DMS Core
============================

The DMS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Krekeler/documentchain/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the DMS Core project (and related
projects such as libsecp256k1), and is not to be confused with overall DMS
Network Protocol consensus changes.

Whether a pull request is merged into DMS Core rests with the project merge
...
Patches that change DMS consensus rules are considerably more involved than
...
Where a patch set proposes to change the DMS consensus, it must have been
...
The review process is normally fairly responsive on the DMS Core repository, however
...
The project leader is the release manager for each DMS Core release.
